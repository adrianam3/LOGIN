...
//TODO: Controlador de fuenteContacto
require_once('revisarsesion.controller.php');
require_once('../models/fuenteContacto.model.php');
...
switch ($_GET["op"]) {
    //TODO: Operaciones de fuenteContacto

    case 'todos': //TODO: Procedimiento para cargar todos los datos de fuenteContacto
        $datos = array();
        $datos = $fuenteContacto->todos();
    ...
    case 'uno': //TODO: Procedimiento para obtener un registro de la base de datos
        ...
        $datos = array();
        $datos = $fuenteContacto->uno($idfuenteContacto);
    ...
    case 'insertar': //TODO: Procedimiento para insertar un registro en la base de datos
        ...
        $datos = array();
        $datos = $fuenteContacto->insertar($nombre, $descripcion, $estado);
    ...
    case 'actualizar': //TODO: Procedimiento para actualizar un registro en la base de datos
        ...
        $estado = $_POST["estado"];
        $datos = array();
        $datos = $fuenteContacto->actualizar($idfuenteContacto, $nombre, $descripcion, $estado);
        echo json_encode($datos);
        break;
    ...
    case 'eliminar': //TODO: Procedimiento para eliminar un registro en la base de datos
        $idfuenteContacto = $_POST["idfuenteContacto"];
        $datos = array();
        $datos = $fuenteContacto->eliminar($idfuenteContacto);
        echo json_encode($datos);
        break;
}
