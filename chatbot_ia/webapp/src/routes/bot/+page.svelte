...
<div class="flex justify-center items-center p-4">
	<div class="m-11 card h-full w-3/4">
		<div class="p-4 md:p-10">
			...
			<br />
			<h3 class="mb-3">Tú Asistente en línea está listo!</h3>
			<p class="text-xl mb-2">Puedes iniciar con tus preguntas:</p>
			<div class="flex">
				<input
					class="input text-xl"
					type="text"
					placeholder="tú pregunta aquí"
					bind:value={query}
				/>
				<button
					type="button"
			...
			{:else}
				...
				<div>
					{#if documents.length > 0}
						<p class="text-xl mb-2 mt-6">Documentos de consulta:</p>
